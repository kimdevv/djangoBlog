...
# SECRET_KEY = 'django-insecure-v%r5^@@qcokqs@q%nw5n7(+@im#66o&3!x2za&2%wx990ayoam'
...
AUTH_USER_MODEL = 'accounts.CustomUser' # 이걸 써줘야 파이썬 내장 User이 아니라 우리가 선언한 CustomUser을 User로 사용한다!
